...
export default function Navbar() {
  ...
  return (
    ...
    backdrop-blur-2xl border-lg border-white/50 flex items-center justify-between px-8 md:px-20 shadow-lg hover:scale-[1.02] transition-transform duration-300'>
